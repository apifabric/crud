...
@Component({
  selector: 'CustomerHistory-home',
  templateUrl: './CustomerHistory-home.component.html',
  styleUrls: ['./CustomerHistory-home.component.scss']
})
export class CustomerHistoryHomeComponent implements AfterViewInit {
